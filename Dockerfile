...
COPY . .
RUN mvn package
RUN cp /boxfuse-sample-java-war-hello/target/simple-servlet-0.1.war /usr/local/tomcat/webapps
RUN rm  /boxfuse-sample-java-war-hello/target/simple-servlet-0.1.war
